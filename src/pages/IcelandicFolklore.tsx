...
export const IcelandicFolklore = () => {
  return (
    <div className="flex flex-col">
      <h1
        className="font-newRocker text-center m-auto text-2xl w-80 mt-10 mb-10
      ...
      <p className="font-montserrat mt-11 mx-5 animate__animated animate__fadeInLeft">
        ...
        folklore is a rich tapestry of myths and legends deeply influenced by
        the country’s rugged landscapes and Norse roots. It includes tales of
        huldufólk (hidden people) and elves, thought to live invisibly alongside
        humans and connected to Iceland's natural landmarks.
      </p>
